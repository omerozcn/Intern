...
.quote-icon { display: grid; place-items: center; width: 40px; height: 40px; border-radius: 12px; color: var(--tv-accent); background: var(--tv-accent-soft); font-size: 1.25rem; }
.feedback-item p { min-height: 84px; margin: 1rem 0; white-space: pre-wrap; overflow-wrap: anywhere; }
.feedback-item > span { color: var(--tv-text-muted); font-size: .75rem; }
